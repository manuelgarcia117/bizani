...
<html lang="es">
    <head>
        ...
        <title>Administrador</title>
            ...
            var torden = 1;
            var dataglobal;
            function listaradministrador(elemento){
                var orden="id";
                var tipoorden="DESC";
                if(elemento==null){
                    orden="id";
                ...
                if(elemento=="id"||elemento=="Name"||elemento=="Email"){
                    orden=elemento;
                    if(torden==0){
                       torden=1; 
                    }
                ...
                $("#tlistaadministrador").children('tr').remove();
		        ...
		        var response = jQuery.parseJSON(data);
		          if(response.stat!=0){
		            ...
		            for(var i = 0;i<response.id.length;i++){
		                ...
		                emailnegrilla = response.email[i].replace(texto,"<b>"+texto+"</b>");
		                if(response.roles[i]==1){
		                    txtrol = "<div id='d"+response.id[i]+"' onclick='cambiarestado(this,"+i+")' class='onoffswitch'><input type='checkbox' name='onoffswitch' class='onoffswitch-checkbox' id='myonoffswitch' checked disabled><label class='onoffswitch-label' for='myonoffswitch'><span class='onoffswitch-inner'></span><span class='onoffswitch-switch'></span></label></div>";
		                }
		                else{
		                    txtrol = "<div id='d"+response.id[i]+"' onclick='cambiarestado(this,"+i+")' class='onoffswitch'><input type='checkbox' name='onoffswitch' class='onoffswitch-checkbox' id='myonoffswitch' disabled><label class='onoffswitch-label' for='myonoffswitch'><span class='onoffswitch-inner'></span><span class='onoffswitch-switch'></span></label></div>";
		                }
		                $("#tlistaadministrador").append("<tr><td data-label='ID' class='sorted integer'>"+idnegrilla+"</td><td data-label='Nombre' class='sorted integer'><div class='divtexto'>"+nombrenegrilla+"</div></td><td data-label='Correo' class='sorted integer'><div class='divtexto'>"+emailnegrilla+"</div></td><td data-label='Administrador'>"+txtrol+"</td><td data-label='Acciones' class=' string ' style='padding-left:4px;padding-right:4px'><button onclick='modal(2,"+i+")' style='margin-right:6px;'><span style='padding-top: 5px;padding-bottom: 5px;' class='fa fa-pencil'></span></button><button onclick='modal(3,"+i+")'><span style='padding-top: 5px;padding-bottom: 5px;' class='fa fa-trash'></span></button></td></tr>");
		            }
		            ...
		            $(".list-pagination").slideDown();
		              ...
		              $("#tlistaadministrador").children('tr').remove();
		              $("#tlistaadministrador").append("<tr><td colspan='7'><center>No Hay Resultados, Intente Otra Busqueda</center></td></tr>");
		              $("#ultima").slideUp();
		              $("#siguiente").slideUp();
		              $("#ultimaa").slideUp();
		              $("#siguientea").slideUp();
        ...
        function modal(num,ind){
          //modificar
            $('#exampleModal').modal('show');
              ...
              $("#txtContrasena").val("");$("#modalestado").empty();
              //switch de estado
              if(dataglobal.roles[ind]=="1"){
          ...
          if(num==1){
             ...
             $("#txtEmail").prop("disabled",false);
              ...
              $("#lblEliminar").slideUp();
              $("#lblRegistrar").slideDown();
              $("#txtId").val("");
              $("#txtNombre").val("");
              $("#txtEmail").val("");
              $("#txtContrasena").val("");
              $("#divcontrasena").slideDown();
          }
          if(num==2){
        ...
        function cambiarestado(e,i){
            ...
            $.get("cambiarestado.php", {rol:rol,id:id}, function(data){
                var response = jQuery.parseJSON(data);
        ...
        function registrar(){
            ...
            var clave =  $("#txtContrasena").val();
            $.get("registrar.php", {name:name,email:email,clave:clave}, function(data){
                var response = jQuery.parseJSON(data);
                if(response.status==1){
            ...
            if(confirm("Esta seguro que desea eliminar este registro?")){
                ...
                if(response.status==1){
                    ...
                    $('#exampleModal').modal('hide');
                     ...
                     listaradministrador();listarinmueble();
                     $('#exampleModal').modal('hide');
                }
            });
            }
        ...
        function modificar(){
            ...
            var clave = $("#txtContrasena").val();
            var id = $("#txtId").val();      
            $.get("modificar.php", {id:id, email:email, name:name, clave:clave}, function(data){
                var response = jQuery.parseJSON(data);
                if(response.status==1){
    ...
    <body id="easyadmin-list-User" class="easyadmin sidebar-mini list list-user" onload="listaradministrador()">
        <div class="wrapper">
            <header class="main-header">
                
                    <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" style="z-index:1">
                    </a>
                        ...
                        <li class="header">Control de Aplicacion</li>
                            ...
                            <li class="   ">
                                <a style="background-color:#96c840;color:#FFF">
                                    <i class="fa fa-cog"></i>            
                                    <span style="cursor:default;color:#FFF">Administradores</span>
                                </a>
                            </li>
                        ...
                        <div class="col-sm-7">
                            <div class="global-actions">
                                <div class="form-action  action-search">
                                    <form>                                                            
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="query" value="" id="texto" onkeyup="listaradministrador(this.id)">
                                            <span class="input-group-btn">
                                                <button class="btn" type=""  id="btexto" onclick="listaradministrador(this.id);return(false)">
                                ...
                                <div class="button-action">
                                    <a class="btn btn-primary action-new" style="background-color:#3fad46;" onclick="modal(1)">Nuevo</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <ul class="pagination list-pagination-paginator first-page ">
                                <li id="lprimera">
                                    <a id="primeraa" onclick="listaradministrador(this.id)" style="cursor:pointer"><i class="fa fa-angle-double-left"></i>Primera</a>
                                </li>
                                
                                <li>
                                    <a id="anteriora" onclick="listaradministrador(this.id)" style="cursor:pointer"><i class="fa fa-angle-left"></i>Anterior</a>
                                </li>
                    
                                <li>
                                    <a id="siguientea" onclick="listaradministrador(this.id)" style="cursor:pointer">Siguiente<i class="fa fa-angle-right"></i></a>
                                </li>
                    
                                <li id="lultima">
                                    <a id="ultimaa" onclick="listaradministrador(this.id)" style="cursor:pointer">Última <i class="fa fa-angle-double-right"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <thead>
                                <tr>
                                    <th data-property-name="id" class="sorted  integer ">
                                        <a id="id" onclick="listaradministrador(this.id)" style="cursor:pointer">
                                    ...
                                    <th data-property-name="email" class="  string ">
                                        <a id="Email" onclick="listaradministrador(this.id)" style="cursor:pointer">
                                    ...
                                    <th data-property-name="name" class="  string ">
                                        <a id="Name" onclick="listaradministrador(this.id)" style="cursor:pointer">
                                            <i class="fa fa-sort"></i>
                                           Nombre
                                        </a>
                                    </th>
                ...
                <div id="pagabajo" class="list-pagination">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <ul class="pagination list-pagination-paginator first-page ">
                                <li id="lprimera">
                                    <a id="primera" onclick="listaradministradores(this.id)" style="cursor:pointer"><i class="fa fa-angle-double-left"></i>Primera</a>
                                </li>
                                
                                <li>
                                    <a id="anterior" onclick="listaradministradores(this.id)" style="cursor:pointer"><i class="fa fa-angle-left"></i>Anterior</a>
                                </li>
                    
                                <li>
                                    <a id="siguiente" onclick="listaradministradores(this.id)" style="cursor:pointer">Siguiente<i class="fa fa-angle-right"></i></a>
                                </li>
                    
                                <li>
                                    <a id="ultima" onclick="listaradministradores(this.id)" style="cursor:pointer">Última <i class="fa fa-angle-double-right"></i></a>
                                </li>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form id="formodal">
                          ...
                          <div id="campoestado" class="form-group">
                            <label for="recipient-name" class="form-control-label">Estado Administración:</label>
                            <div id="modalestado">
                            </div>
                          </div>
                        </form>
                      ...
                      <div class="modal-footer">
                        ...
                        <button id="btnRegistrar" type="button" class="btn btn-success" onclick="registrar()">Registrar</button>
