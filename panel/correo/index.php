...
<html lang="es">
    ...
    <script>
        function enviarcorreo(){
            var destinatario = $("#txtDestintario").val();
            ...
            if(destinatario==""||asunto==""||mensaje==""){
                ...
                $.get("enviar.php", {destinatario:destinatario,asunto:asunto,mensaje:mensaje}, function(data){
                        ...
                        <li class="header">Control de Aplicacion</li>
                            ...
                            <li class="   ">
                                <a style="background-color:#96c840;color:#FFF">
                                    <i class="fa fa-object-ungroup"></i>            
                                    <span style="cursor:default;color:#FFF">Enviar Correo</span>
                                </a>
                            </li>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button id="btnEnviar" type="button" class="btn btn-success" onclick="enviarcorreo()">Enviar</button>                       
                      </div>
                    </div>
                  </div>
                </div>
